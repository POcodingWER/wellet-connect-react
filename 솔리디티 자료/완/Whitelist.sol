...
contract WhiteList is Ownable, AccessControlEnumerable {
  ...
  ///////////////////////////////////WL user check
    ...
    function _isSaleWhitelist(uint256 _saleId, address _address) internal view returns (bool) {
      ...
      /* 스테이킹 홀더검사 */ 
      // if(_getMiyaStakingCount(_address) > 0) {
      //   return true;
      // }
  ...
  //스테이킹 하고있는 홀더검사
  // function _getMiyaStakingCount(address to) public view returns (uint256) {
  //     IMasterFarm masterFarm = IMasterFarm(masterFarmAddr);
  //     return masterFarm.getStakingCount(to);
  // }

...
contract BullBear is ERC721, ERC721Enumerable, ERC721URIStorage, KeeperCompatibleInterface, Ownable  {
    ...
    */
    ...
    constructor(uint updateInterval, address _pricefeed,VRFv2Consumer _addrVRFv2Consumer) ERC721("Bull&Bear", "BBTK") {
        vrfContract = _addrVRFv2Consumer;
    ...
    function performUpkeep(bytes calldata /* performData */ ) external override {
        ...
        if ((block.timestamp - lastTimeStamp) > interval ) {
            vrfContract.requestRandomWords();       //램덤숫자 생성
    ...
    function updateAllTokenUris(string memory trend) internal {
        ...
        uint256[] memory randomWords = vrfContract.getRandomWords();
